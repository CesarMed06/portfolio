...
const projects = [
    {
        ...
        description: 'Buscador de camisetas de fútbol con catálogo filtrable, valoraciones, favoritos, foro y chatbot con IA (Gemini).',
    ...
    },
    {
        ...
        description: 'App de gestión de tareas y objetivos relacionados con el fútbol con seguimiento visual.',
    ...
    },
    {
        ...
        description: 'Réplica visual de la web de Bikes for Refugees Scotland usando solo HTML y CSS.',
        ...
        <section className="home">
            <div className="home__left">
                ...
                <p className="home__description">
                    ...
                    funcionales. Actualmente en segundo año en CEI, con prácticas en empresa.
                </p>
                ...
                <div className="home__stats">
                    ...
                    <div className="home__stat">
                        ...
                        <span className="home__stat-label">Años de formación</span>
                    </div>
                    <div className="home__stat-divider" />
                    <div className="home__stat">
                ...
                <div className="slider">
                    ...
                    <div className="slider__card">
                        ...
                        <div className="slider__body">
                            ...
                            <a href={project.github} target="_blank" rel="noreferrer" className="slider__btn">
                                GitHub
                            </a>
                        </div>
                    </div>
